...
var shouldIBuyThis = function(balance, saverSpender) {
  if ( saverSpender(balance) ) {
...
if (!module.parent) {
  ...
  console.log(smarterShouldIBuyThis(50, 45, yourSpendingStrategy) === "Nope! Gotta keep my savings up!");
